...
fun interface GetAnimeEpisodeUseCase {
    suspend operator fun invoke(id: String): ResultOf<List<EpisodeItem>, AnimeFailure>
}

internal class GetAnimeEpisodeUseCaseImpl @Inject constructor(
    private val episodeRepository: EpisodeRepository
) : GetAnimeEpisodeUseCase {
    override suspend fun invoke(id: String): ResultOf<List<EpisodeItem>, AnimeFailure> =
